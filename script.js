...
span3.innerHTML = "Filter with Ingredient You have :";
span3.style.color = "yellow";
span3.style.margin = "20px";

var input4 = document.createElement("input");
input4.setAttribute("type", "text");
input4.setAttribute("id", "ingredient");
input4.style.width = "275px";
input4.style.margin = "10px";
input4.setAttribute("placeholder", "Enter Main Ingredient");
...
button2.innerHTML = "GetList";
button2.addEventListener("click", ingredients);

var lb1 = document.createElement("br");
divc.append(input, span, input2, span1, label, button, lb, span2, input3, button1,lb1,span3,input4,button2);
...
async function ingredients() {
    try {
        var keyword = document.getElementById("ingredient").value;
        divrow.innerHTML = "";
        divnamelist.innerHTML = "";
       
        var val = null;
        if (keyword != null & keyword != "") {
            val = await fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?i=${keyword}`);
            let res1 = await val.json();
            getList1(res1);

        } else {
            divnamelist.innerHTML = `<span style="color:white;">Please Enter valid key word eg:"Chicken","panner",etc...</span><br><br>`;
        }
